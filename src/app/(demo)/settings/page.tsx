    ...
    <div className="p-8 max-w-5xl">
      <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="bg-[#1a1a1a] rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="bg-[#1a4d2e] text-[#4ade80] px-3 py-1 rounded-full text-[12px] tracking-[-0.12px]">
                  Active
                </span>
              </div>
        ...
        <div className="bg-[#252525] rounded-[20px] p-6">
          ...
          <button className="mt-4 w-full py-3 border border-[#4f4f4f] rounded-lg text-white hover:bg-[#2a2a2a] transition-colors text-[14px] tracking-[-0.14px]">
            + Add Team Member
          </button>
        </div>
